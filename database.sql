...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2023 a las 08:11:14
...
(10, 'society_realestate', 0, NULL),
(11, 'bank_savings', 0, 'char1:1e064b80c59ca4dbaae69307b9d2ae5a44efae60'),
(12, 'property', 0, 'char1:1e064b80c59ca4dbaae69307b9d2ae5a44efae60'),
(13, 'caution', 0, 'char1:1e064b80c59ca4dbaae69307b9d2ae5a44efae60');
...
--
-- Estructura de tabla para la tabla `darkchat_messages`
--
...
--
-- Estructura de tabla para la tabla `instagram_account`
--
...
--
-- Estructura de tabla para la tabla `instagram_followers`
--
...
--
-- Estructura de tabla para la tabla `instagram_posts`
--
...
--
-- Estructura de tabla para la tabla `instagram_stories`
--
...
--
-- Estructura de tabla para la tabla `insta_stories`
--
...
--
-- Estructura de tabla para la tabla `inventory_clothes`
--
...
--
-- Estructura de tabla para la tabla `inventory_glovebox`
--
...
--
-- Estructura de tabla para la tabla `inventory_metadata`
--
...
--
-- Estructura de tabla para la tabla `inventory_stash`
--
...
--
-- Volcado de datos para la tabla `inventory_stash`
--

INSERT INTO `inventory_stash` (`id`, `stash`, `items`) VALUES
(1, 'PoliceArmory_LSPD', '[{\"amount\":5,\"weight\":0,\"unique\":false,\"info\":[],\"slot\":1,\"name\":\"money\",\"label\":\"Money\",\"image\":\"cash.png\",\"useable\":true,\"type\":\"item\"}]'),
(3, 'Stash_Mechanic_society_mechanic', '[]'),
(4, 'Stash_society_mechanic', '[]'),
(5, 'Stash_society_taxi', '[]');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `inventory_trunk`
--
...
('empty_weed_bag', 'Empty Bag', 1, 0, 1),
('essence', 'Gas', 1, 0, 1),
('fabric', 'Fabric', 1, 0, 1),
('fish', 'Fish', 1, 0, 1),
...
('water', 'Water', 1, 0, 1),
('weed_ak47', 'Ak74', 1, 0, 1),
('weed_ak47_seed', 'ak47 Seed', 1, 0, 1),
('weed_amnesia', 'Amnesia', 1, 0, 1),
('weed_amnesia_seed', 'Amnesia Seed', 1, 0, 1),
('weed_nutrition', 'Weed Nutrition', 1, 0, 1),
...
--
-- Estructura de tabla para la tabla `management_outfits`
--
...
--
-- Estructura de tabla para la tabla `phone_accounts`
--
...
--
-- Estructura de tabla para la tabla `phone_alertjobs`
--
...
--
-- Estructura de tabla para la tabla `phone_chats`
--
...
--
-- Estructura de tabla para la tabla `phone_news`
--
...
--
-- Estructura de tabla para la tabla `phone_notifies`
--
...
--
-- Estructura de tabla para la tabla `player_gallery`
--
...
--
-- Estructura de tabla para la tabla `player_notes`
--
...
--
-- Estructura de tabla para la tabla `tiktok_users`
--
...
--
-- Estructura de tabla para la tabla `tiktok_videos`
--
...
--
-- Estructura de tabla para la tabla `tinder_accounts`
--
...
--
-- Estructura de tabla para la tabla `tinder_likes`
--
...
--
-- Estructura de tabla para la tabla `tinder_messages`
--
...
--
-- Estructura de tabla para la tabla `twitter_account`
--
...
--
-- Estructura de tabla para la tabla `twitter_hashtags`
--
...
--
-- Estructura de tabla para la tabla `twitter_mentions`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_accounts`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_chats`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_chats_messages`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_groups_messages`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_groups_users`
--
...
--
-- Estructura de tabla para la tabla `whatsapp_stories`
--
...
--
-- Indices de la tabla `darkchat_messages`
--
...
--
-- Indices de la tabla `instagram_posts`
--
ALTER TABLE `instagram_posts`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `instagram_stories`
--
ALTER TABLE `instagram_stories`
  ADD PRIMARY KEY (`owner`) USING BTREE;

--
-- Indices de la tabla `inventory_clothes`
--
...
--
-- Indices de la tabla `inventory_glovebox`
--
...
--
-- Indices de la tabla `inventory_metadata`
--
ALTER TABLE `inventory_metadata`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indices de la tabla `inventory_stash`
--
ALTER TABLE `inventory_stash`
  ADD PRIMARY KEY (`stash`),
  ADD KEY `id` (`id`);

--
-- Indices de la tabla `inventory_trunk`
--
...
--
-- Indices de la tabla `management_outfits`
--
...
--
-- Indices de la tabla `phone_alertjobs`
--
...
--
-- Indices de la tabla `phone_news`
--
ALTER TABLE `phone_news`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indices de la tabla `phone_notifies`
--
...
--
-- Indices de la tabla `player_gallery`
--
...
--
-- Indices de la tabla `player_notes`
--
...
--
-- Indices de la tabla `tiktok_users`
--
...
--
-- Indices de la tabla `tiktok_videos`
--
ALTER TABLE `tiktok_videos`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indices de la tabla `tinder_accounts`
--
ALTER TABLE `tinder_accounts`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tinder_likes`
--
ALTER TABLE `tinder_likes`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tinder_messages`
--
ALTER TABLE `tinder_messages`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indices de la tabla `twitter_hashtags`
--
ALTER TABLE `twitter_hashtags`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `twitter_mentions`
--
...
--
-- Indices de la tabla `whatsapp_chats`
--
ALTER TABLE `whatsapp_chats`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `whatsapp_chats_messages`
--
...
--
-- Indices de la tabla `whatsapp_groups_messages`
--
...
--
-- AUTO_INCREMENT de la tabla `darkchat_messages`
--
ALTER TABLE `darkchat_messages`
...
--
-- AUTO_INCREMENT de la tabla `instagram_posts`
--
ALTER TABLE `instagram_posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `inventory_clothes`
--
ALTER TABLE `inventory_clothes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `inventory_glovebox`
--
ALTER TABLE `inventory_glovebox`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `inventory_metadata`
--
ALTER TABLE `inventory_metadata`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `inventory_stash`
--
ALTER TABLE `inventory_stash`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `inventory_trunk`
--
ALTER TABLE `inventory_trunk`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `management_outfits`
--
ALTER TABLE `management_outfits`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `phone_alertjobs`
--
ALTER TABLE `phone_alertjobs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `phone_news`
--
ALTER TABLE `phone_news`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `phone_notifies`
--
ALTER TABLE `phone_notifies`
...
--
-- AUTO_INCREMENT de la tabla `player_gallery`
--
ALTER TABLE `player_gallery`
...
--
-- AUTO_INCREMENT de la tabla `player_notes`
--
ALTER TABLE `player_notes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tiktok_users`
--
ALTER TABLE `tiktok_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `tiktok_videos`
--
ALTER TABLE `tiktok_videos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;

--
-- AUTO_INCREMENT de la tabla `tinder_accounts`
--
ALTER TABLE `tinder_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `tinder_likes`
--
ALTER TABLE `tinder_likes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `tinder_messages`
--
ALTER TABLE `tinder_messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `twitter_hashtags`
--
ALTER TABLE `twitter_hashtags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `twitter_mentions`
--
ALTER TABLE `twitter_mentions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `vehicle_sold`
--
ALTER TABLE `vehicle_sold`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `whatsapp_chats`
--
ALTER TABLE `whatsapp_chats`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT de la tabla `whatsapp_chats_messages`
--
ALTER TABLE `whatsapp_chats_messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `whatsapp_groups_messages`
--
ALTER TABLE `whatsapp_groups_messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
