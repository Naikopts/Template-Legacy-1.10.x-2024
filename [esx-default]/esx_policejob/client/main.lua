...
function OpenArmoryMenu(station)
	...
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "PoliceArmory_"..station, other)
	TriggerEvent("inventory:client:SetCurrentStash", "PoliceArmory_"..station)
end
